<template>
  <fragment>
    <div
      class="lifeapp"
      v-if="$store.state.showbox.showlist.length > 0 && this.listpro != null"
    >
      <div class="sort">
        <ul>
          ...
          <li>
            <a href="javascript:;" @click="sort('CreateDate')"
              ...
              <span
                v-if="sortByObject['CreateDate'] === 'asc'"
                class="icon iconfont"
                >&#xe6db;</span
              >
              <span
                v-if="sortByObject['CreateDate'] === 'desc'"
                class="icon iconfont"
                >&#xe6da;</span
              >
            </a>
          ...
          <li>
            <a href="javascript:;" @click="sort('Score')"
              >销量
              <span v-if="sortByObject['Score'] === 'asc'" class="icon iconfont"
                >&#xe6db;</span
              >
              <span
                v-if="sortByObject['Score'] === 'desc'"
                class="icon iconfont"
                >&#xe6da;</span
              ></a
            >
          ...
          <li>
            <a href="javascript:;" @click="sort('Price')"
              ...
              <span v-if="sortByObject['Price'] === 'asc'" class="icon iconfont"
                >&#xe6db;</span
              >
              <span
                v-if="sortByObject['Price'] === 'desc'"
                class="icon iconfont"
                >&#xe6da;</span
              ></a
            >
    ...
    <div class="empty" v-if="listpro.length > 0 && loadAll">
      亲，没有更多了...
    </div>
