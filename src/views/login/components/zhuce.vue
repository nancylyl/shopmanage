  ...
  <div id="zhuce">
    <div id="zhuceBox">
      <form action="/register.do" method="post">
        <div id="box1">
          <label for="">手机号:</label><input @focus="tishi" @blur="xiaoshi" type="text" class="left"  v-model="Phone">
          <span id="tishi">请填写正确的手机号，目前仅支持中国<br>大陆的手机</span>
        </div>
        <div id="box2">
          <label for="" class="tupian">图片码:</label><input type="text" class="left">
        ...
        <div id="box3">
          <label for="">短信码:</label><input type="text" class="left">
        </div>

        <div id="box4">
          <label for="">密码:</label><input type="password" class="left myPwd" @input="countNum"  v-model="PassWord">
          <div class="mybei">
        ...
        <div id="box5">
          <label for="">确认密码:</label><input type="text" class="left">
        </div>
        ...
        <div id="box7">
          ...
          <span>我已经注册,现在就</span>
          <router-link to="/denglu"><a href="">登录</a></router-link>
        </div>
      </form>
    </div>
  </div>
