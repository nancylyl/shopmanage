        ...
        <div class="box-head">
          ...
          <div>
            ...
            <div class="taiTou">
              ...
              <el-radio v-model="radio" label="1" @change="show">单位</el-radio><br>
              <input class="danwei" v-if="tj" type="text" maxlength="30" v-model="mation[0].Inv_Content" placeholder="请输入单位名称">
            </div>
          </div>
...
<script>
    import {updataUserINV,getUserINV} from "../../../../../../../web/shopManage/src/network/person";
