<template>
  <div id="personalData">
    ...
    <div class="box" v-if="personList.length>0">
      ...
      <div class="xinXi">
        <form action="./getUserBC.do" method="post">
          <p class="shuoMin">（在这里填写您的个人资料，请详细填写下每一个栏目）<span>带*的栏目必须填写</span></p>
          <table class="tb">
            <tbody>
            <tr>
              <td class="td1">会员名：</td>
              <td class="td2" ><b>{{personList[0].Account}}</b></td>

            </tr>
            <tr>
              <td class="td1">姓名：</td>
              <td class="td2">
                <input type="text" class="yourInput" v-model="personList[0].Name">
              </td>
            </tr>
            <tr>
              <td class="td1">性别：</td>
...
<!--                <input type="radio" :checked="nv" name="sex"/><span class="font">女</span>-->
            ...
            <tr>
              ...
              <td class="td2">
                <div>
                  ...
                  <router-link to="/PerCenter/personalData/xiuGai" id="xiuGai" mobile="135*****949">修改</router-link>
                </div>
              </td>
            </tr>
            <tr>
              <td class="td1">邮编：</td>
              <td class="td2">
                <input type="text" class="yourInput" v-model="personList[0].Code" vtype="">
              </td>
            </tr>
            <tr class="top10px">
            ...
            <td colspan="2" class="baoCun">
              <button @click="baoCun" class="btton" type="button">保存</button>
            </td>
            </tbody>
